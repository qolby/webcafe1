                                ...
                                <div class="card-body">
                                    <form action="./config/cekregister.php" method="post">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-7">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" name="telepon" id="inputtelepon" type="text" placeholder="Masukkan No. Telepon" />
                                                    <label for="inputtelepon">No. Telepon</label>
                                                </div>
                                                <label class="ms-2">*optional</label>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <select class="form-control form-control" name="jeniskel" id="selectJK">
                                                        <option value="-">-</option>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <input class="form-control" name="repassword" id="inputPasswordConfirm" type="password" placeholder="Confirm password" required />
                                                    <label for="inputPasswordConfirm">Confirm Password</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><input type="submit" name="register" class="btn btn-primary" value="Create Account"></div>
                                        </div>
                                    </form>
                                </div>
